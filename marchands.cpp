...
void halte(Combattant& aylis, const std::vector<Arme>& armes, int visite, int moment) {
    const Marchand maren = {
        "Maren", "l'herboriste",
        {
            ...
            "Le marais de Skarn... Rien que l'odeur me donne la nausee. Fais le plein de potions.",
        },
        {
            ...
            "Skarn empoisonne tout ce qu'il touche, et il frappe de loin. Le sort de Soin guerit le poison, pense-y !",
        },
    ...
    const Marchand durgan = {
        "Durgan", "le forgeron",
        {
            ...
            "Un sorcier, hein ? Les sorciers detestent qu'on leur colle a la peau. Va au contact, vite.",
        },
        {
            ...
            "Skarn n'a presque pas d'armure. Les armes rapides et le saignement vont le mettre a genoux.",
        },
    ...
    const Marchand silas = {
        "Silas", "le collectionneur",
        {
            ...
            "Le masque de Skarn... On dit qu'il murmure encore la nuit. Je paierais une fortune pour l'entendre.",
        },
        {
            ...
            "C'est Skarn qui souffle la rage de Vorgath aux Haschen. Abats-le, et leur fureur s'eteindra peut-etre.",
        },
